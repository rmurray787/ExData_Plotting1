...
par(mfrow=c(2,2))
plot(Sub_metering_1~datetime,data = household_power_consumption, type="l",xaxt="n",ylab="Energy Sub Metering", xlab="")
...
plot(Voltage~datetime,data = household_power_consumption, type="l",xaxt="n",ylab="Global Active Power (kilowatts)")
axis(1,at=as.POSIXct(c("2007-02-01 00:00:00", "2007-02-02 00:00:00", "2007-02-03 00:00:00")), labels = c("Thu", "Fri", "Sat"))

plot(Global_reactive_power~datetime,data = household_power_consumption, type="l",xaxt="n")
axis(1,at=as.POSIXct(c("2007-02-01 00:00:00", "2007-02-02 00:00:00", "2007-02-03 00:00:00")), labels = c("Thu", "Fri", "Sat"))
